...
- **Ridgelines** — seven mountain ranges, each a 1‑D **ridged** fractal-noise silhouette (`1 − |noise|`, for sharp alpine crests rather than rounded hills), composited far to near.
...
- **Snow & sky** — snow on the highest near peaks; a graded dawn sky with sun glow and fractal clouds; a final contrast/vignette grade.

The eight core equations are printed on a placard beneath the render.
